...
//        addButton2.click();
//
//        WebElement firstNameElement2 = driver.findElement(By.id("firstName"));
//        String firstNameValue2 = "Name";
//        firstNameElement2.sendKeys(firstNameValue2);
//
//        WebElement lastNameElement2 = driver.findElement(By.id("lastName"));
//        String lastNameValue2 = "Lastname";
//        lastNameElement2.sendKeys(lastNameValue2);
//
//        WebElement emailAddressElement2 = driver.findElement(By.id("userEmail"));
//        String emailAddressValue2 = "test@test.ro";
//        emailAddressElement2.sendKeys(emailAddressValue2);
//
//        WebElement ageElement2 = driver.findElement(By.id("age"));
//        String ageValue2 = "23";
//        ageElement2.sendKeys(ageValue);
//
//        WebElement salaryElement2 = driver.findElement(By.id("salary"));
//        String salaryValue2 = "1000";
//        salaryElement2.sendKeys(salaryValue2);
//
//        WebElement departmentElement2 = driver.findElement(By.id("department"));
//        String departmentValue2 = "QA";
//        departmentElement2.sendKeys(departmentValue2);
//
//        WebElement submitButtonElement2 = driver.findElement(By.xpath("//button[text()='Submit']"));
...
//
//        Integer index = 0;
//        for (WebElement x : actualEntries) {
//
//            Assert.assertTrue(expectedEntries.get(index).equals(x));
//            index++;
//        }
//
//    }
//
//}
////  if (x.getText().equals(index)){
////          System.out.println("Intrari adaugate")
////        Assert.assertTrue(actualTableSize+index == expectedTablesize);
////        Assert.assertTrue(actualTableSize + index == expectedTablesize)
